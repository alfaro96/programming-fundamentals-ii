# Understanding the Java development lifecycle

This example **demonstrates** the **basic structure** of a **Java application** and the **process** of **creating** a **program** that **outputs text** to the console.
